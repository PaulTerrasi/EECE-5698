...
"""autogenerated by genpy from rtk_gps_pkg/NavSatFix.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import rtk_gps_pkg.msg
import std_msgs.msg

class NavSatFix(genpy.Message):
  _md5sum = "2d3a8cd499b9b4a0249fb98fd05cfa48"
  _type = "rtk_gps_pkg/NavSatFix"
...
"""
  ...
  _slot_types = ['std_msgs/Header','rtk_gps_pkg/NavSatStatus','float64','float64','float64','float64[9]','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.status is None:
        self.status = rtk_gps_pkg.msg.NavSatStatus()
